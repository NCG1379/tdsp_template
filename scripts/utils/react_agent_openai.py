...
def react_openai(ioc):
    ...
    output_filename = f"output/conversation_log_openai_{ioc_}.txt"
...
if __name__ == "__main__":
    final_ans = react_openai(ioc="94.124.15.40")
